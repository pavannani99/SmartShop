  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40 md:hidden">
      <div className="flex justify-around items-center py-2">
        <Button variant="ghost" className="flex flex-col items-center p-1 h-auto min-w-0 text-gray-500" aria-label="Home">
        ...
        <Button variant="ghost" className="flex flex-col items-center p-1 h-auto min-w-0 text-gray-500" aria-label="Cart">
